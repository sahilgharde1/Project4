...
public class MarksheetCtl extends BaseCtl{
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("physics")) && !DataValidator.isInteger(request.getParameter("physics"))) {
			...
			request.setAttribute("physics", "Marks cannot be More than 100");
			pass = false;
		...
		if (DataValidator.isNull(request.getParameter("chemistry"))) {
			...
			request.setAttribute("chemistry", "Marks cannot be More than 100");
			pass = false;
		...
		if (DataValidator.isNull(request.getParameter("maths"))) {
			...
			request.setAttribute("maths", "Marks cannot be More than 100");
			pass = false;
